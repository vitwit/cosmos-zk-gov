...
type App struct {
	*baseapp.BaseApp
	...
	ZkGovKeeper           zkgovKeeper.Keeper
	// the module manager
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".zkapp")
}
...
func NewApp(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		authzkeeper.StoreKey, nftkeeper.StoreKey, zktypes.StoreKey,
	)
	...
	*/
	...
	app.ZkGovKeeper = zkgovKeeper.NewKeeper(codec.NewProtoCodec(interfaceRegistry), runtime.NewKVStoreService(keys[zktypes.StoreKey]))
	/****  Module Options ****/
	...
	app.ModuleManager = module.NewManager(
		...
		zkgov.NewAppModule(appCodec, app.ZkGovKeeper),
	)
	...
	genesisModuleOrder := []string{
		...
		vestingtypes.ModuleName, consensusparamtypes.ModuleName, circuittypes.ModuleName, zktypes.ModuleName}
